...
| #   | Module                                                              | Group                  |
| --- | ------------------------------------------------------------------- | ---------------------- |
| 00  | [Prerequisite review](modules/00-prerequisite-review.md)            | Prerequisite review    |
| 01  | [Scalar autodiff](modules/01-autodiff.md)                           | Foundations            |
| 02  | [Tensors and matmul](modules/02-tensors.md)                         | Foundations            |
| 03  | [A first neural network](modules/03-nn.md)                          | Foundations            |
| 03B | [Training](modules/03b-training.md)                                 | Foundations            |
| 04  | [Tokenization](modules/04-tokenizer.md)                             | Language               |
| 05  | [Embeddings and positions](modules/05-embeddings.md)                | Language               |
| 06  | [Next-token prediction](modules/06-language-models.md)              | Language               |
| 07  | [Self-attention](modules/07-attention.md)                           | The transformer        |
| 08  | [Multi-head attention](modules/08-multi-head-attention.md)          | The transformer        |
| 09  | [The transformer block](modules/09-transformer-block.md)            | The transformer        |
| 09B | [Pretraining](modules/09b-pretraining.md)                           | The transformer        |
| 10  | [Milestone: TinyLLM](modules/10-tinyllm.md)                         | The transformer        |
| 11  | [Sampling and decoding](modules/11-sampling.md)                     | The transformer        |
...
| #   | Module                                                              | Group                  |
| --- | ------------------------------------------------------------------- | ---------------------- |
| 12  | [Scaling experiments](modules/12-scaling.md)                        | Behavior shaping       |
| 13  | [Instruction tuning (SFT)](modules/13-sft.md)                       | Behavior shaping       |
| 13B | [LoRA](modules/13b-lora.md)                                         | Behavior shaping       |
| 14  | [Preference tuning (DPO)](modules/14-dpo.md)                        | Behavior shaping       |
| 15  | [Hallucination and evaluation](modules/15-evaluation.md)            | Behavior shaping       |
| 16  | [Local pretrained models and inference](modules/16-inference.md)    | Assistant systems      |
| 16B | [Synthetic data](modules/16b-synthetic-data.md)                     | Assistant systems      |
| 17  | [Retrieval-augmented generation](modules/17-rag.md)                 | Assistant systems      |
| 18  | [Tool use](modules/18-tools.md)                                     | Assistant systems      |
| 19  | [Agent loops](modules/19-agent.md)                                  | Assistant systems      |
| 20  | [Capstone: a tiny ChatGPT](modules/20-capstone.md)                  | Assistant systems      |

Part II can also be entered directly if you already know the fundamentals and want the systems material — see [Module 12](modules/12-scaling.md).
...
Each module in the course has a lesson page and a set of deliverables combining a coding project and a problem set. The lesson pages are hosted on this site and also available as markdown in the [course repo](https://github.com/Mister-Meeseeks/g2c). 
