...
Open or resume the working notebook with `./notebook.sh 03` (or `./notebook.sh 03 --fresh` to reset from the clean scaffold). The notebook contains runnable experiments and detailed prompts; implementation work lives in `g2c/nn/`.
