...
- **Repeats itself.** Ask for enough batches and the proposals collapse toward a few favorite neighborhoods. The dedup gate measures this directly: `ngram_overlap` against the cumulative pool. The cumulative pool is essential, dedup against a fixed set would happily accept fifty copies of the same idea. The rate at which this gate fires is your first empirical measurement of mode collapse.
